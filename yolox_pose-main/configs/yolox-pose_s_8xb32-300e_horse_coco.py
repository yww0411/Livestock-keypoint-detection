...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_pose=dict(
            type='OksLoss',
            metainfo='/hy-tmp/keypoint-detection/yolox_pose-main/configs/_base_/datasets/custom4horse.py',
            loss_weight=30.0),
        loss_bbox_aux=dict(
    ...
    train_cfg=dict(
        assigner=dict(
            ...
            oks_calculator=dict(
                type='OksLoss', metainfo='/hy-tmp/keypoint-detection/yolox_pose-main/configs/_base_/datasets/custom4horse.py'))),
    test_cfg=dict(
        yolox_style=True,
        multi_label=False,
        score_thr=0.001,
